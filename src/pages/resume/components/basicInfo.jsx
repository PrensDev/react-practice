...
class BasicInfo extends Component {
	...
	getApplicantEmail = () => {
		...
		return email
			? <span>{email}</span>
			: <span className="text-secondary fst-italic">[Your email will appear here]</span>
	}
	...
	getApplicantContactNumber = () => {
		...
		return contact_number
			...
			: <span className="text-secondary fst-italic">[Your contact number will appear here]</span>
	}

	getApplicantLinks = () => {
		const { links } = this.props.applicant || false;
		return !links
			? <span className="text-secondary fst-italic">[Your links will appear here]</span>
			: links.map((l, i) =>
				<div key={i}>
